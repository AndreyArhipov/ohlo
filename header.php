...
require_once __DIR__ . '/../.././blogs/blogs.php';

$blogs = new Blogs();

//var_dump(CHV\Login::getUser()['id']);
?>
<!DOCTYPE HTML>
...
<?php G\Render\include_theme_file('custom_hooks/head'); ?>
	...
	<?/* СТИЛИ ИЗМЕНЕНИЙ ШАБЛОНА */?>
<link rel="stylesheet" href="<?=mylib_get_cach_file('http://media.caraf.ru/lib/src/huck_css.css')?>">
</head>
    ...
    <div class="content-width">
        ...
        <ul class="top-bar-left float-left">
			...
			<li id="top-bar-explore" data-nav="explore" class="phone-hide pop-keep-click pop-btn pop-btn-show<?php if(in_array(G\get_route_name(), ['explore','category'])) { ?> current<?php } ?>">
				...
				?>
                <span class="top-btn-text"><span class="icon icon-stack"></span><span class="btn-text phone-hide phablet-hide">Площадки</span></span>
                <div class="pop-box <?php if($cols > 1) { echo sprintf('pbcols%d ', $cols); } ?>arrow-box arrow-box-top anchor-left">
					<div class="pop-box-inner pop-box-menu<?php if($cols > 1) { ?> pop-box-menucols<?php } ?>">
						<!--<div class="pop-box-label"><?php _se('Discovery'); ?></div>-->
						<ul>
							<?php
								require_once __DIR__ . '/../.././blogs/modules/areas.class.php';

								$data = array("type" => "list");
								$areas = new Areas($data);
...
<span class="top-btn-text"><span class="icon icon-info tablet-hide laptop-hide desktop-hide"></span><span class="text phone-hide phablet-hide"><?php// _se('About'); ?>Линки</span><span class="arrow-down"></span></span>
                <div class="pop-box arrow-box arrow-box-top anchor-right">
                    <div class="pop-box-inner pop-box-menu">
...
<?/* МЕНЮ ПО ССЫЛКАМ */?>						
						<ul>
							...
							<?php if(is_admin()) { ?>
							<li class="with-icon"><a href="<?=_SETTINGS_PATH_CATALOG_?>/plugin" target=""><span class="btn-icon icon-code2"></span> Плагин</a></li>
							<li class="with-icon"><a href="<?=_SETTINGS_PATH_CATALOG_?>/page/comments" target=""><span class="btn-icon icon-code2"></span> соц активность</a></li>
							
							<? } ?>
							<li class="with-icon"><a href="/"><span class="btn-icon icon-home"></span> Главная</a></li>
							
							<li><a href="/page/privacy"><span class="btn-icon icon-file"></span> Правила</a></li>
							<li><a href="/" target="_blank"><span class="btn-icon icon-instagram2"></span> Наш Инстаграм</a></li>  
							<li><a href="/page/contact"><span class="btn-icon icon-mobile"></span> Контакты</a></li>
